...
with skip_run("run", "Example 1: Always") as check, check():
    ...
    mean, var = linear_system(
        a=0.01, b=1.0, g=1.0, q=2.5, mu=50, P=0.15, t=t, control_func=sinusoidial_input
    )
...
with skip_run("run", "Example 3: Combined") as check, check():
    t = np.linspace(0, 20, 100)
    mean, var = linear_system(
        a=0.05, b=1.0, g=0.5, q=0.5, mu=50, P=1.0, t=t, control_func=sinusoidial_input
    )
...
with skip_run("run", "Example 4: Piecewise") as check, check():
    ...
    mean, var = linear_system(
        a=0.0, b=1.0, g=0.5, q=0.5, mu=50, P=4.0, t=t, control_func=piecewise_input
    )
